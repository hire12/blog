...
//   const [isAdmin, setIsAdmin] = useState<boolean>(true); // For checking if the user is an admin
...
//       // Optionally, refresh the articles list here
//     } catch (error) {
...
//     // Redirect to edit page (you need to create the edit page)
//     window.location.href = `/admin/articles/edit/${id}`;
//   };

//   const handleAdd = () => {
//     // Redirect to add page (you need to create the add page)
