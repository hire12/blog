          ...
          <div className="mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            ...
            {articles
              ...
              .map((article) => (
                <article
                key={article.id}
                className="px-6  bg-white rounded-lg border shadow-md flex mb-8"
              >
                <div className="flex-none w-1/2 "> {/* Fixed height for image container */}
                  <Image
                ...
                <div className="flex-1 p-6 flex flex-col justify-between h-64"> {/* Ensure text section has the same height */}
                  <div>
              ...
              {articles
                ...
                .map((article) => (
                  <article key={article.id} className="p-6 bg-white rounded-lg border shadow-md">
                    <div className="h-64 mb-4"> {/* Fixed height for image container */}
                      <Image
